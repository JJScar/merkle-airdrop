...
contract MakeMerkle is Script, ScriptHelper {
    ...
    Merkle private murky = new Merkle(); // instance of the merkle contract from Murky to do stuff
    ...
    function run() public {
        ...
        for (uint256 i = 0; i < count; ++i) {
            ...
            string memory proof = bytes32ArrayToString(murky.getProof(leafs, i));
            // get the root hash and stringify
            string memory root = vm.toString(murky.getRoot(leafs));
